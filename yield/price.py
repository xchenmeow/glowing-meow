...
import datetime
import math
# inport user-defined modules
from daycount import DayCountConventions
...
basis = DayCountConventions.actual360
...
m1 = settleTime.month
d1 = settleTime.day
# print settleTime.strftime("%a")
test = datetime.datetime.strptime(settlement, "%Y-%m-%d")
print type(test)
print test
